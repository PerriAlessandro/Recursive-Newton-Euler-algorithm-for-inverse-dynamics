...
robot.Data(2).axangrot =axang2rotm( [0 1 0 pi/2]); %fixed rotation wrt the previous frame
...
%LINK 1
robot.Config(1).q = 2*pi/3;
robot.Config(1).qd = -0.4;
robot.Config(1).qdd = -0.1;

%LINK 2
robot.Config(2).q = 0.6;
robot.Config(2).qd = -0.08;
